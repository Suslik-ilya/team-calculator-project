...
# build directory.
TK_BUILD_LIB_SPEC='-L/run/build/tk/unix -ltcl9tk9.0'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/app/lib -ltcl9tk9.0'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/app/include'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/run/build/tk/unix -ltkstub'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/app/lib -ltkstub'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/run/build/tk/unix/libtkstub.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/app/lib/libtkstub.a'

# Top-level directory in which Tk's demo files are installed.
TK_DEMO_DIR='/app/lib/tk9.0/demos'
